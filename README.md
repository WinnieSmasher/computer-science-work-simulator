...
这个项目不是刷题仓库，也不是某个培训材料的复刻。它把你发来的 PDF 里“模拟工作”27 关能力点，转写成 27 个后端开发工作模拟关卡，用一个原创业务系统 `NovaMart` 串起来：商品、标签、用户端列表、订单、库存、支付、通知、缓存、消息队列、部署、文档和复杂方案阅读。
...
- 第 01-27 关已按 PDF 能力点重写为后端开发模拟工作。
- 第 02-04 关已有商品/标签 API、后台商品列表和 MockMvc 测试作为起步代码。
- 后续会按关卡逐步补业务代码、测试和技术文档。
